...
import com.miniclaw.engine.impl.FileSessionStore;
import com.miniclaw.memory.impl.KeywordScorer;
...
public class SessionService {
    ...
    private static final List<com.miniclaw.tools.schema.ToolDefinition> EMPTY_TOOLS = List.of();
    ...
    private static String formatMessagesForSummary(List<Message> messages) {
        ...
        int count = 0;
        for (Message msg : messages) {
            if (msg.role() == com.miniclaw.tools.schema.Role.SYSTEM) continue;

...
```bash
java -jar clawkit-cli/target/clawkit-cli-0.1.0-SNAPSHOT.jar
```

常用启动方式：

```bash
java -jar clawkit-cli/target/clawkit-cli-0.1.0-SNAPSHOT.jar --root C:\path\to\project
java -jar clawkit-cli/target/clawkit-cli-0.1.0-SNAPSHOT.jar -m deepseek-chat
java -jar clawkit-cli/target/clawkit-cli-0.1.0-SNAPSHOT.jar --thinking
java -jar clawkit-cli/target/clawkit-cli-0.1.0-SNAPSHOT.jar --im=feishu
```

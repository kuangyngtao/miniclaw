...
class MessageMaskerTest {
    ...
    @Test
    void shouldMaskAlways() {
        // Phase 4: TRIGGER_TURNS=0, masking always enabled
        assertThat(MessageMasker.shouldMask(1)).isTrue();
        assertThat(MessageMasker.shouldMask(5)).isTrue();

 ...
 *
 * 运行: mvn exec:java -pl clawkit-engine -Dexec.classpathScope=test
 *   -Dexec.mainClass=com.clawkit.engine.impl.WriteBashIntegrationTest
 */
public class WriteBashIntegrationManual {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 1. 创建测试工作区
        Path workDir = Path.of(System.getProperty("java.io.tmpdir"), "clawkit-write-bash-test");
